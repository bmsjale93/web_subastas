...
try {
    ...
    $stmt = $conn->prepare("SELECT s.*, c.*, v.*, l.*, sd.precio_medio, sd.precio_venta_min, sd.precio_venta_medio, sd.precio_venta_max, sd.url_pdf_precios, ts.tipo_subasta, s.puja_mas_alta
                        FROM Subastas s
